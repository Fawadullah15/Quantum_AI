...
export default function NewTechnologyPage() {
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-3xl font-bold mb-8">Add Technology</h1>
      <form onSubmit={handleSubmit} className="space-y-6 bg-[var(--color-surface)] p-8 border border-[var(--color-border)]">
        ...
        <div>
          ...
          <textarea required name="description" rows={3} className="w-full bg-[var(--color-bg)] border border-[var(--color-border)] p-3" />
        </div>

        <div>
          <label className="block text-sm font-mono mb-2">Usage (How we use it)</label>
          <input name="usage" className="w-full bg-[var(--color-bg)] border border-[var(--color-border)] p-3" />
        </div>

        <div>
          <label className="block text-sm font-mono mb-2">Projects (Comma separated slugs)</label>
          <input name="projects" className="w-full bg-[var(--color-bg)] border border-[var(--color-border)] p-3" />
        </div>

        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-mono mb-2">Icon URL</label>
