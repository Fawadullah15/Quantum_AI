...
import { GlobeLocation } from '@/components/3d/PremiumGlobe';
  ...
  loading: () => (
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem' }}>
        ...
        />
        INITIALIZING 3D PLANETARY SYSTEM...
      </div>
    </div>
  ),
});
...
const REGIONS = [
  { id: 'all', label: 'GLOBAL NETWORK', subLabel: '9 Active Edge Regions', lat: 25, lng: 45, ping: '24ms' },
  { id: 'na', label: 'NORTH AMERICA', subLabel: 'New York & San Francisco', lat: 40.71, lng: -74.0, ping: '18ms' },
  { id: 'eu', label: 'EUROPE', subLabel: 'London & Paris Nodes', lat: 51.5, lng: -0.12, ping: '26ms' },
  { id: 'me', label: 'MIDDLE EAST', subLabel: 'Dubai Enterprise Hub', lat: 25.2, lng: 55.27, ping: '31ms' },
  { id: 'sa', label: 'SOUTH ASIA', subLabel: 'Lahore Engineering HQ', lat: 31.52, lng: 74.35, ping: '22ms' },
  { id: 'ea', label: 'ASIA PACIFIC', subLabel: 'Singapore & Tokyo Clusters', lat: 35.68, lng: 139.65, ping: '28ms' },
  { id: 'oc', label: 'OCEANIA', subLabel: 'Sydney Edge Node', lat: -33.87, lng: 151.21, ping: '42ms' },
];
...
export default function GlobalEarthSection() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const el = document.getElementById('global-infrastructure');
      if (!el) return;
