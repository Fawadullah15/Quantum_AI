...
export const sampleLeadership: LeaderItem[] = [
  {
    ...
    fullBio: 'Muhammad guides the architectural vision and engineering standards at Quantum AI, partnering with enterprise leaders to transform complex operational bottlenecks into intelligent, scalable software systems.',
    email: 'murtaza@quantumai.dev',
